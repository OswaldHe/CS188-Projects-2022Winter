...
For better visual performance, we will use the pretrained model in `taming-transformer`, with a more detailed prompt to guide the image generation. The result is shown in the video below:
